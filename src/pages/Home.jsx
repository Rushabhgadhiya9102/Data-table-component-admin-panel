...
import user1 from '../assets/img/jm_denis.jpg'
import user2 from '../assets/img/talha.jpg'
import user3 from '../assets/img/chadengle.jpg'


const Home = (props) => {
  const { productData, xAxisData, seriesData } = props;
